...
//Switch from 0th Tab to 1st Tab
  ...
  @Test(priority=2)
  public void test_Queries_feedback() throws InterruptedException
  {
	  driver.get("https://pizzaonline.dominos.co.in/");
	  driver.manage().window().maximize();
	//  Thread.sleep(12000);
	...
	//  driver.findElement(By.xpath("//li[text()='Disclaimer']/following::*[41]")).click();
		  ...
		  WebElement chat=new WebDriverWait(driver,Duration.ofSeconds(60)).
		  until(ExpectedConditions. presenceOfElementLocated(By.xpath("//li[text()='Disclaimer']/following::*[41]")));
		  chat.click();
	  ...
	  Thread.sleep(5000);
	  //User Click On Queries & feedback
	  driver.findElement(By.xpath("//strong[text()='Queries & feedback']")).click();
	  Thread.sleep(5000);
	//User Enter Mobile Number
	  driver.findElement(By.xpath("//input[@id='ymMsgInput']")).sendKeys("9900877665");
	  Thread.sleep(5000);
	  //User Click on Send
	  driver.findElement(By.xpath("//i[@id='sendIcon']")).click();
	  Thread.sleep(5000);
	...
	//Verify OTP Text
		String ExpOTPmsg="Please enter the 6 digit OTP sent to your mobile number.";
		String ActOTPmsg=driver.findElement(By.xpath("//div[contains(text(),'Please enter the 6')]")).getText();
		Assert.assertEquals(ActOTPmsg, ExpOTPmsg);
		 Thread.sleep(5000);
	//User Click on Home
		 driver.findElement(By.xpath("//input[@id='ymMsgInput']/following::*[20]")).click();
		 Thread.sleep(5000);
  }
  
  @Test(priority=3)
  public void test_Track_current_order() throws InterruptedException
  {
	  driver.get("https://pizzaonline.dominos.co.in/");
	  driver.manage().window().maximize();
	  Thread.sleep(9000);
	  ...
	  Thread.sleep(5000);
	  //User Click On Track current order
  ...
  @Test(priority=4)
  public void test_Contact_store() throws InterruptedException
  {
	  driver.get("https://pizzaonline.dominos.co.in/");
	  driver.manage().window().maximize();
	  Thread.sleep(9000);
